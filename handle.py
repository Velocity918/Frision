...
inputs = processor(
    images=image,
    text = """
object.fruit. vegetable.banana. item. thing. food. drink. container.
package. box. bottle. jar. can. bag. carton.
fruit. vegetable. ingredient. utensil.
""",
    return_tensors="pt"
).to(device)
